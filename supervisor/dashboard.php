...
<body style="background-color:#eee">
	  	...
	  	<div id="content" class="p-4 p-md-5 pt-5">
	        ...
	        <div class="container p-4"  id="storeItems" style="border: 1px solid grey">
	        	...
	        	<?php 
	        		if(!checksupervisee($supervisoruserId)){
	        	?>
	        		<div class="text-center py-3" style="font-style: italic;">
	        			Sorry, Your supervisees are not yet registred.<br> Please Check in again later...
	        		</div>
	        	<?php
	        		}else{
	        		...
	        		global $ConnectingDB;
                        $sql = "SELECT * FROM registertbl, studentdetails WHERE registertbl.id=studentdetails.studentid AND studentdetails.supervisorid = '$supervisoruserId'";
	        	...
	        	<div class="d-flex justify-content-between p-3"style="border-bottom: 1px solid grey">
	        		<div><b><span><?php echo $SN;?>. </span> <?= $studentname;?></b> |<i style="font-size: 14px"> <?=$regno;?></i></div>
